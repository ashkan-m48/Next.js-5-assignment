...
import { deleteRecipes, editRecipes } from "@/utils/action";

function ListOfDataRecipes({ postData }) {
  async function handleChange(arg, id) {
    await editRecipes(arg.firstName, arg.lastName, id);
  }
...
export default ListOfDataRecipes;
